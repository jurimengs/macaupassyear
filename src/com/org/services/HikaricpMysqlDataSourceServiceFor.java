 ...
 *
 */
public class HikaricpMysqlDataSourceServiceFor {
	
	public static HikaricpMysqlDataSourceServiceFor getInstance(){
		if(hds == null){
			hds = new HikaricpMysqlDataSourceServiceFor();
		}
		return hds;
	}
	...
	private static HikaricpMysqlDataSourceServiceFor hds = null;
	
	private HikaricpMysqlDataSourceServiceFor(){
