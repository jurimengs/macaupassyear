...
<body class="login-bg">
    ...
    <form action="/macaupassyear/tomanager.do" method="post" id="loginform">
	</form>
	
    <div class="load-input">
		<input type="text" placeholder="請輸入口令" id="enterpwd" class="input loadinbg center">
	</div>
...
function checklgn(){
	...
	$.ajax({
		type:"post",
		url:"/macaupassyear/managechecklgn.do",
		data:{
			enterpwd: enterpwd
		},
		dataType:"json",
